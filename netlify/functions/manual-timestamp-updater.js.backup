// HTTP-callable version of the timestamp updater (same logic as scheduled version)
const fetch = require('node-fetch');
const cheerio = require('cheerio');

exports.handler = async (event, context) => {
    console.log('🔧 Manual timestamp-based updater starting...');
    ...
    try {
        ...
        console.error('❌ Error in manual updater:', error);
